...
public class Resistor {
    ...
    public double getCurrent() {
        //FIX THIS
        return this.initialvoltage/this.initialresistance;
    }
    ...
    public void setCurrent(double current) {
        //FIX THIS
        this.initialvoltage = this.initialresistance*current;
    }
    ...
    public double getPower() {
        //FIX THIS
        return this.initialvoltage*getCurrent();
    }
